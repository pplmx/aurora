...
func main() {
	...
	voter1 := &models.Vote{Token: ed25519.PublicKey{}, Candidate: candidate1.GetName()}
	voter2 := &models.Vote{Token: ed25519.PublicKey{}, Candidate: candidate2.GetName()}
	voter3 := &models.Vote{Token: ed25519.PublicKey{}, Candidate: candidate3.GetName()}
	...
	voter1.Token = publicKey1
	voter2.Token = publicKey2
	voter3.Token = publicKey3
	...
	voter1.Signature = signature1
	voter2.Signature = signature2
	voter3.Signature = signature3
